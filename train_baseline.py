...
from model import GRUMortalityModel
...
def main():
    ...
    model = GRUMortalityModel(input_dim=X.shape[-1], hidden_dim=64).to(device)
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        if val_auc > best_val_auc:
            ...
            best_epoch = epoch
            patience_counter = 0
            torch.save(model.state_dict(), "best_baseline_gru.pt")
